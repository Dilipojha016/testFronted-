...
function Page(props) {
  ...
  return (
    ...
    >
     <a style={props.isActive ? activeBg : disableClass?grayBg:null} disabled={disableClass?"disabled":""} href="#prop">
        {props.text}
      </a>
    </li>
  );
...
function Pagination(props) {
  ...
  return (
    <ul className={`pagination ${size}`} style={{ margin: '0px auto' }}>
      ...
      {props.hasPrevious && props.pages > 0 && (
        <Page
